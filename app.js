...
function sumAndMultiply(a, b, c) {
    let sumr = sum(a,b)[0] + c
    let multr = multiply(a,b)[0] * c
    let message =`${a} and ${b} and ${c} sum to ${sumr}.`
    let messagee=`The product of ${a} and ${b} and ${c} is ${multr}.`
    return[sumr,multr,message,messagee];
}
